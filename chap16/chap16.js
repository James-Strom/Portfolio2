...
function askQuestion(questionNumber) {
    ...
    switch (questionNumber) {
        ...
        case 2:
            ...
            break;
        case 3:
            question.innerHTML = "Go with martian, or go with crew";
            break;
        case 4:
            question.innerHTML = "Chocolate, or pizza.";
            break;
        default:
            break;
    }
...
function continueStory(answerNumber) {
    switch (answerNumber) {
        ...
        case 2:
            ...
            break;
        case 3:
            if (answers[3] === "GO WITH MARTIAN") {
                story.innerHTML = document.getElementById("answer24").innerHTML;
                askQuestion(4);
            } else if (answers[3] === "GO WITH CREW") {
        ...
        case 4:
            if (answers[4] === "PIZZA") {
                story.innerHTML = document.getElementById("answer25").innerHTML;
                theEnd();
            } else if (answers[4] === "CHOCOLATE") {
                story.innerHTML = document.getElementById("answer26").innerHTML;
                theEnd();
            } else {
                story.innerHTML = document.getElementById("err4").innerHTML;
                askQuestion(4);
